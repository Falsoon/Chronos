...
public class Map implements StateEditable, Serializable {
	...
	private boolean transparentWallMode, opaqueWallMode, dooring, archwayAdd, deleting, keyPlace, lockDooring;
...
//		}
   ...
   public void archwayAdd() {
	...
	public boolean isCreating() {
		return transparentWallMode || opaqueWallMode || archwayAdd || keyPlace|| dooring || lockDooring || player.isPlacing();
	}
